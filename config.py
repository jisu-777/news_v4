...
COMPANY_KEYWORD_MAP = {
    ...
    # 경쟁사 그룹 - 회계법인 관련 키워드 (고유한 키워드만 사용)
    "한영EY": ["한영", "한영회계", "한영회계법인", "EY", "한영EY", "한영EY회계"],
    "삼정KPMG": ["삼정회계", "삼정KPMG", "삼정KPMG법인", "KPMG", "삼정KPMG회계"],
    "Deloitte": ["딜로이트안진", "안진회계", "안진회계법인", "Deloitte", "딜로이트안진회계"],
    
    # 삼일PwC 그룹 - 핵심 키워드 (독립적인 카테고리)
    "삼일PwC": ["삼일회계", "삼일PwC", "삼일", "삼일회계법인", "삼일PwC법인", "PwC삼일", "PwC코리아"],
